package org.optimizationBenchmarking.evaluator.attributes.statistics.propertyExtremals;
...
public final class ExtremalPropertyValues<PT extends IPropertyValue>
  ...
  public final boolean equals(final Object o) {
    ...
    if (o instanceof ExtremalPropertyValues) {
      ...
      return (Compare.equals(this.m_min.getValue(), ex.m_min.getValue()) && //
          Compare.equals(this.m_max.getValue(), ex.m_max.getValue()));
    }
