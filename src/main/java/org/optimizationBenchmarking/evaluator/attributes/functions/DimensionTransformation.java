...
public final class DimensionTransformation extends Transformation
  ...
  public final ETextCase printDescription(final ITextOutput textOut,
    ...
    use = textCase.appendWords("the values of dimension", //$NON-NLS-1$
        textOut);
    textOut.append(' ');
    use = SemanticComponentUtils
        .printLongAndShortNameIfDifferent(this.m_dimension, textOut, use);
    if (!(this.isIdentityTransformation())) {
      textOut.append(' ');
  ...
  private final class __ParameterRenderer
    ...
    public final boolean equals(final Object o) {
      return ((o == this) || //
          ((o instanceof DimensionTransformation.__ParameterRenderer) && //
              (DimensionTransformation.this
                  .equals(((__ParameterRenderer) o).__getOwner()))));
    }
  }
}
